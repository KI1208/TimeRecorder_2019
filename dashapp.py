...
# color_dict = {'colors': ['red', 'blue', 'green', 'pink', 'gray', 'yellow', 'purple']}
...
dashapp.layout = html.Div(
    children=[
        ...
        dcc.Graph(
            id="weekly-taskbalance",
            figure={'data': [dash_task_balance],
                    'layout': {'title': 'Task Balance',
                               }
                    }
        ),
        dcc.Graph(
            id="weekly-projectbalance",
            figure={'data': [dash_project_balance],
